...
<?php
  if (tep_not_null($_POST['individual_banner_id']) || tep_not_null($_REQUEST['individual_banner_id'])) {

    if (tep_not_null($_POST['individual_banner_id'])) $individual_banner_id = $_POST['individual_banner_id'];
    if ($_REQUEST['individual_banner_id']) $individual_banner_id = $_REQUEST['individual_banner_id'];
