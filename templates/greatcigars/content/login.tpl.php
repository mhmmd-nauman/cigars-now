...
<?php
  if (($messageStack->size('login') > 0 ) && $messageStack->size('login_invalid_char') == 0) {
?>
      <tr>
...
?>
<?php
  if ($messageStack->size('login_invalid_char') > 0) {
		$_POST['email_address']="";
		$_REQUEST['email_address']="";
?>
      <tr>
        <td><?php echo $messageStack->output('login_invalid_char'); ?></td>
      </tr>
      <tr>
        <td><?php echo tep_draw_separator('pixel_trans.gif', '100%', '10'); ?></td>
      </tr>
            ...
            <td width="50%" height="100%" valign="top"><table border="0" width="100%" height="100%" cellspacing="1" cellpadding="2" class="infoBox">
              <tr class="infoBoxContents">
                <td><table border="0" width="100%" height="100%" cellspacing="0" cellpadding="2">
                  ...
                  <tr>
                    <td class="smallText" colspan="2"><?php echo '<a style="color:#000000;" href="' . tep_href_link(FILENAME_PASSWORD_FORGOTTEN, '', 'SSL') . '">' . TEXT_PASSWORD_FORGOTTEN . '</a>'; ?></td>
                  </tr>
                  <tr>
                    <td colspan="2"><?php echo tep_draw_separator('pixel_trans.gif', '100%', '10'); ?></td>
                  </tr>
