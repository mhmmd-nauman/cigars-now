    ...
    <!-- PWA BOF -->
    <?php echo tep_draw_form('create_account', tep_href_link(FILENAME_CREATE_ACCOUNT, (isset($_REQUEST['guest'])? 'guest=guest':''), 'SSL'), 'post', 'onSubmit="return check_form(create_account);"') . tep_draw_hidden_field('action', 'process'); ?><table border="0" width="100%" cellspacing="0" cellpadding="0">
    <!-- PWA EOF -->
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            <?php
            // PWA BOF
            if (!isset($_REQUEST['guest']) && !isset($_POST['guest'])){
            ?>
...
?>
              <tr>
                <td class="main"><?php echo ENTRY_COUNTRY; ?><span id="indicator" style=" display:none"><?php echo tep_image(DIR_WS_IMAGES . 'ajax-loader.gif'); ?></span></td>
				<?php // +Country-State Selector ?>
                <td class="main"><?php echo tep_get_country_list('country',$country,'onChange="getStates(this.value, \'states\');"') . '&nbsp;' . (tep_not_null(ENTRY_COUNTRY_TEXT) ? '<span class="inputRequirement">*</span>': ''); ?></td>
				<?php // -Country-State Selector ?>
              </tr>
            </table></td>
          </tr>
