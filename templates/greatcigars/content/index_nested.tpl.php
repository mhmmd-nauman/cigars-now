...
/* eof catdesc for bts1a */
			...
			<!--
			<?php echo tep_image(DIR_WS_IMAGES . CATEGORY_IMAGES_DIR . $category['categories_image'], $category['categories_name'], HEADING_IMAGE_WIDTH, HEADING_IMAGE_HEIGHT); ?>
			-->
			</td>
          </tr>
...
// check to see if there are deeper categories within the current category
    ...
    $cPath_new = tep_get_path($categories['categories_id'], $categories['parent_id'], $categories['grand_parent_id']);
      ...
      echo '                <td align="center" class="smallText" width="' . $width . '" valign="top"><a href="' . tep_href_link($categories['cat_url'].'.html', $cPath_new) . '">' . tep_image(DIR_WS_IMAGES . CATEGORY_IMAGES_DIR . $categories['categories_image'], $categories['categories_name'], SUBCATEGORY_IMAGE_WIDTH, SUBCATEGORY_IMAGE_HEIGHT) . '<br>' . $categories['categories_name'] . '</a></td>' . "\n";
...
// needed for the new products module shown below
	...
	//tep_href_link($tree[$counter]['cat_url'].".html", $cPath_new) . '">';
