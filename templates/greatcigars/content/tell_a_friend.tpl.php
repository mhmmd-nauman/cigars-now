    <?php
      ...
      if ($valid_product) {
        echo tep_draw_form('email_friend', tep_href_link(FILENAME_TELL_A_FRIEND, 'action=process&products_id=' . $_REQUEST['products_id']));
        } else if ($valid_article) {
          echo tep_draw_form('email_friend', tep_href_link(FILENAME_TELL_A_FRIEND, 'action=process&articles_id=' . $_REQUEST['articles_id']));
      }
            ...
            <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
                ...
                <td><?php
                    ...
                    if ($valid_product) {
                      echo '<a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $_REQUEST['products_id']) . '">' . tep_image_button('button_back.gif', IMAGE_BUTTON_BACK) . '</a>';
                      } else if ($valid_article) {
                        echo '<a href="' . tep_href_link(FILENAME_ARTICLE_INFO, 'articles_id=' . $_REQUEST['articles_id']) . '">' . tep_image_button('button_back.gif', IMAGE_BUTTON_BACK) . '</a>';
                    }
                       ?></td>
